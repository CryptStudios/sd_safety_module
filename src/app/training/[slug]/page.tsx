    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
      <div className="grid gap-8 lg:grid-cols-[1.18fr_0.82fr]">
        <section className="rounded-[16px] border border-rule bg-paper p-6 text-ink shadow-[0_36px_100px_-50px_rgba(0,0,0,0.18)] sm:p-8 lg:p-10">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-tight sm:text-5xl">{category.title}</h1>
        ...
        <aside className="space-y-6">
          <div className="rounded-[16px] border border-rule bg-paper p-5 text-ink shadow-[0_24px_60px_-42px_rgba(2,6,23,0.45)] sm:p-6">
            <p className="eyebrow text-hi-deep">
              Source Basis
            </p>
            <h2 className="mt-3 text-2xl font-bold tracking-tight">
              Toolbox Talk references
            </h2>
            <p className="mt-3 text-sm leading-7 text-ink-2">
              These links support the Toolbox Talk content in this category and can be used for
              additional reading.
            </p>
          ...
          <div className="rounded-[16px] border border-rule bg-paper p-5 text-ink shadow-[0_24px_60px_-42px_rgba(2,6,23,0.45)] sm:p-6">
            ...
            <p className="mt-2 text-sm leading-7 text-ink-2">
              Toolbox Talks in this category
            </p>
          </div>
        </aside>
      </div>
      ...
      <section className="mt-10">
        <TopicBrowser
          ...
          topics={category.topics.map((topic) => ({
            ...
            articleIntro: topic.articleIntro,
            sectionHeadings: topic.articleSections.slice(0, 3).map((section) => section.heading),
          }))}
        />
      </section>
    </div>
