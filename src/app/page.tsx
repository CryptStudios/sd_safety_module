    ...
    <div className="pb-16">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-4">
          {processSteps.map((step, index) => (
            ...
            >
              ...
              <p className="mt-6 text-sm font-black text-amber-600">{index + 1}. {step.title}</p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link
            href="/training"
            className="inline-flex w-fit items-center rounded-full bg-slate-950 px-6 py-3 text-sm font-black text-white transition hover:bg-amber-400 hover:text-slate-950"
          >
