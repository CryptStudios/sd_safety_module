...
export default function GeneralAcknowledgmentPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
      <section className="rounded-[16px] border border-rule bg-paper p-6 text-center text-ink shadow-[0_36px_100px_-50px_rgba(0,0,0,0.9)] sm:p-10 lg:p-16">
        ...
        <p className="mt-6 eyebrow text-hi-deep">
          Forms & Reports
        </p>
